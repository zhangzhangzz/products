        ...
        <div style="padding:30px;">
            ...
            <form id="formmy" class="layui-form" action="{{url('admin/menu/update/'.$list -> id)}}" method="post" lay-filter="example">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="name" value="{{ $list -> name  }}" placeholder="请输入菜单名称" autocomplete="off" class="layui-input name">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                    <input type="text" name="url" value="{{ $list -> url  }}" placeholder="请输入URL" autocomplete="off" class="layui-input url">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <select name="boss"  value="{{ $list -> boss  }}"  lay-filter="filter" lay-verify="required" class="boss">

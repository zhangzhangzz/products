...
<link rel="stylesheet" href="{{ asset('css/business_assess.css') }}">
@section('content')
    <div>
        <ul>
...
layui.use(['element','table','rate','layer'], function(){
        ...
        var data1 = [
            {id:1,img:"{{ asset('image/logo.png') }}",goodsname:'五常大米',price:'8.8',time:'1553654760',
                custname:'丑八怪',orderid:'13122225555',assess:'xx东西很好。。。。。。',level:3,action:'-'},
            {id:2,img:"{{ asset('image/logo.png') }}",goodsname:'五常大米',price:'8.8',time:'1553654760',
                custname:'丑八怪',orderid:'13122225555',assess:'xx东西很好。。。。。。',level:4,action:'-'},
            {id:3,img:"{{ asset('image/logo.png') }}",goodsname:'五常大米',price:'8.8',time:'1553654760',

        ...
        <div style="padding:30px;">
            ...
            <form id="formmy" class="layui-form" action="<?php echo e(url('admin/menu/update/'.$list -> id)); ?>" method="post" lay-filter="example">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="name" value="<?php echo e($list -> name); ?>" placeholder="请输入菜单名称" autocomplete="off" class="layui-input name">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                    <input type="text" name="url" value="<?php echo e($list -> url); ?>" placeholder="请输入URL" autocomplete="off" class="layui-input url">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <select name="boss"  value="<?php echo e($list -> boss); ?>"  lay-filter="filter" lay-verify="required" class="boss">
